...
#undef DefineVectorValueType
        ...
        if (opts->m_generateTruth) {
            ...
            std::shared_ptr<Helper::ReaderOptions> vectorOptions(
                    new Helper::ReaderOptions(valueType, opts->m_dim, opts->m_vectorType, opts->m_vectorDelimiter));
            ...
            std::shared_ptr<Helper::ReaderOptions> queryOptions(
                    new Helper::ReaderOptions(valueType, opts->m_dim, opts->m_queryType, opts->m_queryDelimiter));
